import 'package:cad_project/modules/cut_set_screens/complete_cut_set_screen.dart';
...
class SetupCutSetScreen extends StatefulWidget {
  const SetupCutSetScreen({Key? key}) : super(key: key);

  @override
  State<SetupCutSetScreen> createState() => _SetupCutSetScreenState();
}

class _SetupCutSetScreenState extends State<SetupCutSetScreen> {
              ...
              Container(
                ...
                child: ElevatedButton(
                  ...
                  async {
                    ...
                    print(AT);
                    print(AL);
                    Navigator.push(context, MaterialPageRoute(builder: (context) => const CompleteCutSetScreen(),),);
                  },
                  child: const Text(
                    'Next',
                  ),
