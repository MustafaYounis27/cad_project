...
class _CompleteCutSetScreenState extends State<CompleteCutSetScreen> {
            ...
            children: [
              ...
              Container(
                ...
                child: ElevatedButton(
                  ...
                  async {
                    await m();
                    Calculations(isTieSet: false, AT: AT, AL: AL, Yb: YB, Eb: EB, Ib: IB);
                  },
                  child: const Text(
                    'Next',
                  ),
  ...
  Future<void> m() async
  {
    ...
    IB.clear();
    EB.clear();
    for(int i = 0 ; i < int.parse(yYBController.text == '' ? '0' : yYBController.text) ; i++)
    {
